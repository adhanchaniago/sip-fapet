...
if($param=='all'){
    ...
    $query = mysqli_query($con, "SELECT * FROM mahasiswa WHERE idmahasiswa='$param'")or die(mysqli_error($con));
}
?>
<html>
                ...
                <tr>
                    <td width="50%" style="border:0.5px solid;">
                        <table width="100%" style="font-size:8pt;">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><?=$row['jenjang'].'/'.$row['program_studi'];?></td>
                            </tr>
                            <tr>
                                <td></td>
                    ...
                    <td width="50%" style="padding:15px;border:0.5px solid;">
                        ...
                        <div style="text-align:center;">
                            <img alt="<?=$row['nim'];?>"
                                src="../config/barcode.php?size=30&text=<?=$row['nim'];?>&print=true" />
                        </div>
                    </td>
                </tr>
            </table>
